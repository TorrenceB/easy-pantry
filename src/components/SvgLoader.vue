<template>
  ...
  <svg
    ...
    x="0px"
    y="0px"
    viewBox="0 0 210.627 210.627"
    style="enable-background:new 0 0 210.627 210.627;"
    xml:space="preserve"
    :fill="styles.fill"
    :width="styles.width"
    :height="styles.height"
  >
    <g>
      <g>
        <g>
          <path
            d="M182.906,84.982c0-26.533,7.281-80.25,7.358-80.791c0.155-1.144-0.235-2.295-1.05-3.11
          ...
          />
          <path
            d="M138.567,72.049c0-1.158-0.545-2.252-1.469-2.951c-0.927-0.696-2.129-0.916-3.24-0.603l-7.559,2.162l1.155-9.234
          ...
          />
          <path
            d="M127.482,40.642c6.113,0,11.085-4.972,11.085-11.085c0-6.113-4.972-11.085-11.085-11.085
          ...
          />
          <path
            d="M149.652,44.337c-6.113,0-11.085,4.972-11.085,11.085c0,6.113,4.972,11.085,11.085,11.085
...
export default {
  ...
  computed: {
    getSvg() {
      return this.svgs.filter((svg) => svg === this.svg);
    },
  },
};
</script>
